...
import AimsProject.hust.soict.dsai.aims.media.comparator.MediaComparatorByTitleCost;
...
public class CartController {
    ...
    void btnViewStorePressed(ActionEvent event) {
        try {
            final String STORE_FXML_FILE_PATH = "AimsProject/hust/soict/dsai/aims/screen/view/store.fxml";
